...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/custom/bootsrap4/bootstrap.min.css') }}" >
    <link rel="stylesheet" href="{{ asset('/custom/bootsrap4/font-awesome.min.css') }}" >
    <link href='https://fonts.googleapis.com/css?family=Montserrat:400,700|Source+Sans+Pro:400,600' rel='stylesheet' type='text/css'>
...
<body>
    ...
    <script src="{{ asset('/custom/bootsrap4/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('/custom/bootsrap4/popper.min.js') }}"></script>
    <script src="{{ asset('/custom/bootsrap4/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/custom/bootsrap4/Chart.min.js') }}"></script>
