...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/custom/bootsrap3/bootstrap.min.css') }}" >
    <link rel="stylesheet" href="{{ asset('/custom/bootsrap3/font-awesome.min.css') }}" >
    <link href='https://fonts.googleapis.com/css?family=Montserrat:400,700|Source+Sans+Pro:400,600' rel='stylesheet' type='text/css'>
...
<body>
    ...
    <script src="{{ asset('/custom/bootsrap3/jquery.min.js') }}"></script>
    <script src="{{ asset('/custom/bootsrap3/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/custom/bootsrap3/Chart.min.js') }}"></script>
