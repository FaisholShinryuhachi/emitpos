                                ...
                                draw: function (t) {
                                    ...
                                    if (i.display) {
                                        ...
                                        if (h.drawBorder) {
                                            ...
                                            p
                                                ? ((W = N =
                                                      'top' === i.position ? e.bottom : e.top),
                                                  (W += V),
                                                  (N += V))
                                                : ((z = B =
                                                      'left' === i.position ? e.right : e.left),
                                                  (z += V),
                                                  (B += V)),
                                                r.beginPath(),
                                                r.moveTo(z, W),
                                        ...
                                        if (n.display) {
                                            ...
                                            o.each(t.legendItems, function (e, n) {
                                                ...
                                                w
                                                    ...
                                                    : l + M > t.bottom &&
                                                      ((r = d.x =
                                                          r + t.columnWidths[d.line] + a.padding),
                                    ...
                                    if (
                                        ...
                                        a.each(o, function (o, r) {
                                            var l = i.getDatasetMeta(r),
                                                u = [
                                                    l.type,
                                                    void 0 === n.stacked && void 0 === l.stack
                                                        ? r
                                                        : '',
                                                    l.stack,
                                                ].join('.');
